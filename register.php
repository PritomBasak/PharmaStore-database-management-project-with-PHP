                    ...
                    <div class="signup-form">
                        ...
                        <?php include('errors.php'); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="pass" name="pass" id="pass"required="_required" placeholder="Pass"/>
                            </div>
                            <div class="form-group">
                                <label for="re-pass"><i class="zmdi zmdi-lock-outline"></i></label>
                                <input type="pass" name="pass_2" id="pass_2"required="_required" placeholder="Repeat your password"/>
                            </div>
